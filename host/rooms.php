      ...
      <form id="feature_s_form">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form action="regist_rooms.php" method="POST">
              <div class="row">
                  ...
                  <div class="row align-items-center">
                    <div class="col-md-3 mb-3">
                      <div class="form-check">
                        <input class="form-check-input" type="checkbox" value="wifi" name="wifi" id="wifi">
                    ...
                    <div class="col-md-3 mb-3">
                      <div class="form-check">
                        <input class="form-check-input" type="checkbox" value="tv" name="tv" id="tv">
                        <label class="form-check-label">
                          TV
                        </label>
                      </div>
                    ...
                    <div class="col-md-3 mb-3">
                      <div class="form-check">
                        <input class="form-check-input" type="checkbox" value="heater" name="heater" id="heater">
                        <label class="form-check-label">
                          난방기
                        </label>
                      </div>
                ...
                <div class="col-12 mb-3">
                  ...
                  <div class="row">
                    <div class="col-md-3 mb-3">
                      <div class="form-check">
                        <input class="form-check-input" type="checkbox" value="bedroom" name="bedroom" id="bedroom">
                    ...
                    <div class="col-md-3 mb-3">
                      <div class="form-check">
                        <input class="form-check-input" type="checkbox" value="kitchen" name="kitchen" id="kitchen">
                    ...
                    <div class="col-md-3 mb-3">
                      <div class="form-check">
                        <input class="form-check-input" type="checkbox" value="bathroom" name="bathroom" id="bathroom">
                    ...
                    <div class="col-md-3 mb-3">
                      <div class="form-check">
                        <input class="form-check-input" type="checkbox" value="balcony" name="balcony" id="balcony">
